                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="view/images/products/large-size/1.jpg">
                                    <img class="w-100" src="view/images/products/large-size/1.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="view/images/products/large-size/2.jpg">
                                    <img class="w-100" src="view/images/products/large-size/2.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="view/images/products/large-size/3.jpg">
                                    <img class="w-100" src="view/images/products/large-size/3.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="view/images/products/large-size/4.jpg">
                                    <img class="w-100" src="view/images/products/large-size/4.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="view/images/products/large-size/5.jpg">
                                    <img class="w-100" src="view/images/products/large-size/5.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide w-100" href="view/images/products/large-size/6.jpg">
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="view/images/products/small-product/1.jpg" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="view/images/products/small-product/2.jpg" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="view/images/products/small-product/3.jpg" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="view/images/products/small-product/4.jpg" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="view/images/products/small-product/5.jpg" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="view/images/products/small-product/6.jpg" alt="Product">
                                </div>
                            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide product-wrapper">
                                    ...
                                    <div class="product product-border-left" data-aos="fade-up" data-aos-delay="500">
                                        ...
                                        <div class="content">
                                            <h4 class="sub-title"><a href="index.php?act=single-product">Lather Design</a></h4>
                                ...
                                <div class="swiper-slide product-wrapper">
                                    ...
                                    <div class="product product-border-left" data-aos="fade-up" data-aos-delay="600">
                                        ...
                                        <div class="content">
                                            <h4 class="sub-title"><a href="index.php?act=single-product">Design Source</a></h4>
