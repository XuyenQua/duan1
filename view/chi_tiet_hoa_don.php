                            ...
                            <div class="country-select">
                             ...
                             <div class="col-md-12">
                                 <div class="checkout-form-list">
                                     ...
                                     <input name="" value="<?=get_trang_thai($trang_thai);?>" readonly placeholder="Nhập họ và tên" type="text">
                                 </div>
                             </div>
                             <div class="col-md-12">
                                 <div class="checkout-form-list">
                                     <label>Ngày đặt hàng <span class="required"></span></label>
                                     <input name="" value="<?=$ngay_dat_hang?>" readonly placeholder="Nhập họ và tên" type="text">
                                 </div>
                             </div>
                             <div class="col-md-12">
                                 <div class="checkout-form-list">
                            ...
                            <div class="checkout-form-list">
                             ...
                             <div class="col-md-12">
                                 <div class="checkout-form-list">
                                     ...
                                     <input type="text" name="" value="<?= get_pttt_one($pttt);?>" id="" readonly>
                                 </div>
                             </div>
                            ...
                            <div>
                             ...
                             <div class="order-notes mt-3 mb-n2">
                                 <div class="checkout-form-list checkout-form-list-2">
                                     ...
                                     <textarea id="checkout-mess" readonly name="ghi_chu" cols="30" rows="10" ><?=$ghi_chu?></textarea>
                                 </div>
                             </div>
                             ...
                             <tbody>
                                    ...
                                    ?>
                                     <tr class="cart_item">
                                         ...
                                         <td class="cart-product-total text-end pe-0"><span class="amount"></span> <?=$thanh_tien?> VNĐ</span></td>
                                     </tr>
