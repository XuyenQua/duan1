                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="index.php?act=single-product&id=<?= $id ?>" class="image">
                                        ...
                                        ?>
                                        <img class="first-image" src="<?= $img_path . $anh_sp[0]['anh_sp'] ?>" height="269"
                                            alt="Product" />
                                        <img class="second-image" src="<?= $img_path . $anh_sp[1]['anh_sp'] ?>" height="269"
                                            alt="Product" />
                                    </a>
                                ...
                                <div class="content">
                                    <h4 class="sub-title"><a href="index.php?act=single-product&id=<?= $id ?>">
                                            <?= $thuong_hieu_sp ?>
                                        </a></h4>
                                    <h5 class="title"><a href="index.php?act=single-product&id=<?= $id ?>">
                                            <?= $ten_sp ?>
                                        </a></h5>
                                    <!-- <span class="ratings">
                                    ...
                                    <div class="shop-list-btn">
                                        ...
                                        <form action="index.php?act=add-cart" method="post">
                                            ...
                                            <input type="hidden" name="anh_sp"
                                                value="<?= $img_path . $anh_sp[0]['anh_sp'] ?>">
