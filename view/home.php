                    ...
                    <div class="banner" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="info">
                            <div class="small-banner-content">
                                ...
                                <a href="index.php?act=shop-grid" class="btn btn-dark btn-sm">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="swiper-wrapper mb-n10">
                                        ...
                                        <div class="swiper-slide product-wrapper">
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="300">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/1.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/5.jpg" alt="Product" />
                                                    </a>
                                                    <div class="actions">
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="400">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/2.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/3.jpg" alt="Product" />
                                                    </a>
                                                    <div class="actions">
                                                        <a href="#" class="action wishlist"><i class="pe-7s-like"></i></a>
                                                        <a href="#" class="action quickview" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="pe-7s-search"></i></a>
                                        ...
                                        <div class="swiper-slide product-wrapper">
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="400">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/4.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/10.jpg" alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="500">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/5.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/6.jpg" alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                        ...
                                        <div class="swiper-slide product-wrapper">
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="500">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/7.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/9.jpg" alt="Product" />
                                                    </a>
                                                    <div class="actions">
                                                        <a href="#" class="action wishlist"><i class="pe-7s-like"></i></a>
                                                        <a href="#" class="action quickview" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="pe-7s-search"></i></a>
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="600">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/10.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/4.jpg" alt="Product" />
                                                    </a>
                                                    <div class="actions">
                                                        <a href="#" class="action wishlist"><i class="pe-7s-like"></i></a>
                                                        <a href="#" class="action quickview" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="pe-7s-search"></i></a>
                                        ...
                                        <div class="swiper-slide product-wrapper">
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="600">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/11.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/10.jpg" alt="Product" />
                                                    </a>
                                                    <div class="actions">
                                                        <a href="#" class="action wishlist"><i class="pe-7s-like"></i></a>
                                            ...
                                            <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="700">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img class="first-image" src="view/images/products/medium-size/3.jpg" alt="Product" />
                                                        <img class="second-image" src="view/images/products/medium-size/5.jpg" alt="Product" />
                                                    </a>
                                                    <div class="actions">
                                                        <a href="#" class="action wishlist"><i class="pe-7s-like"></i></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12" data-aos="fade-up" data-aos-delay="300">
                    <div class="banner">
                        <div class="banner-image">
                            <a href="index.php?act=shop-grid"><img src="view/images/banner/big-banner.jpg" alt="Banner"></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide product-wrapper" data-aos="fade-right" data-aos-delay="600">
                                            ...
                                            <div class="product single-deal-product product-border-left">
                                                <div class="thumb">
                                                    <a href="index.php?act=single-product-sale" class="image">
                                                        <img src="view/images/products/medium-size/1.jpg" alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h4 class="sub-title"><a href="index.php?act=single-product-sale">Studio Design</a></h4>
                                                    <h5 class="title"><a href="index.php?act=single-product-sale">Enjoy The Rest T-Shirt</a></h5>
                                                    <span class="ratings">
															<span class="rating-wrap">
																<span class="star" style="width: 100%"></span>
                                                    </span>
                                        ...
                                        <div class="swiper-slide product-wrapper" data-aos="fade-left" data-aos-delay="600">
                                            ...
                                            <div class="product single-deal-product product-border-left">
                                                <div class="thumb">
                                                    <a href="index.php?act=single-product-sale" class="image">
                                                        <img src="view/images/products/medium-size/8.jpg" alt="Product" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <p class="inner-desc">Hurry Up! Offer Ends In:</p>
                                                    ...
                                                    <h4 class="sub-title"><a href="index.php?act=single-product-sale">Studio Design</a></h4>
                                                    <h5 class="title"><a href="index.php?act=single-product-sale">Classic Trucker Hat</a></h5>
                                                    <span class="ratings">
															<span class="rating-wrap">
                                        ...
                                        <div class="swiper-slide product-wrapper">
                                            ...
                                            <div class="product single-deal-product product-border-left">
                                                <div class="thumb">
                                                    <a href="index.php?act=single-product-sale" class="image">
                                                        <img src="view/images/products/medium-size/9.jpg" alt="Product" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <p class="inner-desc">Hurry Up! Offer Ends In:</p>
                                                    ...
                                                    <h4 class="sub-title"><a href="index.php?act=single-product-sale">Studio Design</a></h4>
                                                    <h5 class="title"><a href="index.php?act=single-product-sale">Basic Lather Sneaker</a></h5>
                                                    <span class="ratings">
															<span class="rating-wrap">
																<span class="star" style="width: 80%"></span>
                                                    </span>
        ...
        <div class="container">
            ...
            <div class="row mb-n6 overflow-hidden">
                ...
                <div class="col-md-6 col-12 mb-6" data-aos="fade-right" data-aos-delay="300">
                    <div class="banner">
                        <div class="banner-image">
                            <a href="index.php?act=shop-grid"><img src="view/images/banner/banner-4.jpg" alt="Banner Image"></a>
                        </div>
                        <div class="info">
                            <div class="small-banner-content">
                                <h4 class="sub-title">Up to <span>50%</span> Off</h4>
                                <h3 class="title">Office Dress</h3>
                                <a href="index.php?act=shop-grid" class="btn btn-primary btn-hover-dark btn-sm">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12 mb-6" data-aos="fade-left" data-aos-delay="300">
                    <div class="banner">
                        <div class="banner-image">
                            <a href="index.php?act=shop-grid"><img src="view/images/banner/banner-5.jpg" alt="Banner Image"></a>
                        </div>
                        <div class="info">
                            <div class="small-banner-content">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image" src="view/images/products/small-product/2.jpg" alt="Product" />
                                                <img class="second-image" src="view/images/products/small-product/3.jpg" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><a href="single-product.html">Basic Jogging Shorts</a></h5>
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image" src="view/images/products/small-product/4.jpg" alt="Product" />
                                                <img class="second-image" src="view/images/products/small-product/10.jpg" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><a href="single-product.html">Simple Woven Fabrics</a></h5>
                                ...
                                <div class="swiper-slide product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image" src="view/images/products/small-product/5.jpg" alt="Product" />
                                                <img class="second-image" src="view/images/products/small-product/6.jpg" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><a href="single-product.html">Make Thing Happen T-Shirt</a></h5>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image" src="view/images/products/small-product/7.jpg" alt="Product" />
                                                <img class="second-image" src="view/images/products/small-product/9.jpg" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><a href="single-product.html">Basic Lather Sneaker</a></h5>
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image" src="view/images/products/small-product/11.jpg" alt="Product" />
                                                <img class="second-image" src="view/images/products/small-product/10.jpg" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image" src="view/images/products/small-product/3.jpg" alt="Product" />
                                                <img class="second-image" src="view/images/products/small-product/5.jpg" alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">
