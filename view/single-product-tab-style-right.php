                    ...
                    <div class="product-details-img d-flex overflow-hidden flex-row">
                        ...
                        <div class="single-product-vertical-tab vertical-style-tab swiper-container gallery-top order-1 ms-0 me-2">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide h-auto" href="view/images/products/large-size/1.jpg">
                                    <img class="w-100" src="view/images/products/large-size/1.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide h-auto" href="view/images/products/large-size/2.jpg">
                                    <img class="w-100" src="view/images/products/large-size/2.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide h-auto" href="view/images/products/large-size/3.jpg">
                                    <img class="w-100" src="view/images/products/large-size/3.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide h-auto" href="view/images/products/large-size/4.jpg">
                                    <img class="w-100" src="view/images/products/large-size/4.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide h-auto" href="view/images/products/large-size/5.jpg">
                                    <img class="w-100" src="view/images/products/large-size/5.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide h-auto" href="view/images/products/large-size/6.jpg">
