                    ...
                    <div class="product-carousel single-product-slider">
                        ...
                        <div class="swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide product product-border-left" href="view/images/products/large-size/1.jpg">
                                    <img class="w-100" src="view/images/products/large-size/1.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="view/images/products/large-size/2.jpg">
                                    <img class="w-100" src="view/images/products/large-size/2.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="view/images/products/large-size/3.jpg">
                                    <img class="w-100" src="view/images/products/large-size/3.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="view/images/products/large-size/4.jpg">
                                    <img class="w-100" src="view/images/products/large-size/4.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="view/images/products/large-size/5.jpg">
                                    <img class="w-100" src="view/images/products/large-size/5.jpg" alt="Product">
                                </a>
                                <a class="swiper-slide product product-border-left" href="view/images/products/large-size/6.jpg">
