                ...
                <div class="col-lg-6 offset-lg-0 col-md-8 offset-md-2 col-custom order-md-1 order-lg-2">
                    ...
                    <div class="product-details-img">
                        <div class="gallery-image popup-gallery row mb-n6">
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="view/images/products/large-size/1.jpg">
                                <img class="w-100 border" src="view/images/products/large-size/1.jpg" alt="Product">
                            </a>
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="view/images/products/large-size/2.jpg">
                                <img class="w-100 border" src="view/images/products/large-size/2.jpg" alt="Product">
                            </a>
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="view/images/products/large-size/3.jpg">
                                <img class="w-100 border" src="view/images/products/large-size/3.jpg" alt="Product">
                            </a>
                            <a class="single-product-gallery col-12 col-sm-6 mb-6" href="view/images/products/large-size/4.jpg">
                                <img class="w-100 border" src="view/images/products/large-size/4.jpg" alt="Product">
                            </a>
                        </div>
                    </div>
