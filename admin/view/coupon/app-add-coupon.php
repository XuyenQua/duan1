<form action="index.php?act=app-add-coupon" method="post">
    <!-- sa-app__body -->
                        ...
                        <div class="sa-entity-layout__main">
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4"><label for="form-coupon/code" class="form-label">Mã giảm giá</label><input name="ma_giam_gia" type="text" class="form-control" id="form-coupon/code" required /></div>
                                    <!-- <div class="mb-4">
                                    ...
                                    <div class="mb-4"><label for="form-coupon/value" class="form-label">Giá trị</label><input name="gia_tri" type="number" min="1" class="form-control" id="form-coupon/value" required  /></div>
                                    <div class="mb-4"><label for="form-coupon/limit" class="form-label">Số luọng</label><input name="so_luong" type="number" min="1" class="form-control" id="form-coupon/limit"  required/></div>
