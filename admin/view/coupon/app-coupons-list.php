        ...
        <div class="container">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><a href="index.php?act=app-add-coupon" class="btn btn-primary">Thêm mã giảm giá</a></div>
                </div>
            </div>
            <div class="card">
                ...
                <table class="sa-datatables-init text-nowrap" data-order="[[ 1, &quot;asc&quot; ]]" data-sa-search-input="#table-search">
                    ...
                    <tbody>
                        <?php 
                            foreach ($ds_ma_giam_gia as $giam_gia) {
                                extract($giam_gia);
                        ...
                        <tr>
                            ...
                            <td><a href="index.php?act=app-coupon&id=<?=$id_giamgia?>" class="text-reset"><?=$id_giamgia?></a></td>
                            <td><?=$ma_giam_gia?></td>
                            <td><?=$giam_gia?></td>
                            <td><?=$so_luong?></td>
                            <td>
                                <div class="dropdown"><button class="btn btn-sa-muted btn-sm" type="button" id="coupon-context-menu-0" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg xmlns="http://www.w3.org/2000/svg" width="3" height="13" fill="currentColor">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="coupon-context-menu-0">
                                        <li><a class="dropdown-item" href="index.php?act=app-edit-coupon&id=<?=$id_giamgia?>">sửa</a></li>
                                        ...
                                        <li><a class="dropdown-item text-danger" onclick="xoaKhong('index.php?act=app-del-coupon&iddel=<?=$id_giamgia?>')" href="#">Xóa</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
