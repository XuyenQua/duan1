         ...
         <div class="container container--max--lg">
             ...
             <div class="card">
                 <div class="card-body p-5">
                     <div class="mb-4"><label for="form-settings/name" class="form-label">Store Name</label><input type="text" class="form-control" id="form-settings/name" value="Stroyka" /></div>
                     ...
                     <div class="mb-n2"><label for="form-settings/email" class="form-label">Email Address</label><input type="email" class="form-control" id="form-settings/email" aria-describedby="form-settings/email/help" value="stroyka@example.com" />
             ...
             <div class="card mt-5">
                 <div class="card-body p-5">
                     ...
                     <div class="row g-4">
                         <div class="col-6"><label for="form-settings/weight-unit" class="form-label">Weight Unit</label><select id="form-settings/weight-unit" class="form-select">
                                 <option selected="">kg</option>
                                 <option>g</option>
                                 <option>lbs</option>
                                 <option>oz</option>
                             </select></div>
                         <div class="col-6"><label for="form-settings/dimensions-unit" class="form-label">Dimensions Unit</label><select id="form-settings/dimensions-unit" class="form-select">
             ...
             <div class="card mt-5">
                 <div class="card-body p-5">
                     ...
                     <div class="mb-4"><label for="form-settings/timezone" class="form-label">Timezone</label><select id="form-settings/timezone" class="form-select">
                     ...
                     <div class="mb-4"><label for="form-settings/date-format" class="form-label">Date Format</label><select id="form-settings/date-format" class="form-select">
                     ...
                     <div><label for="form-settings/time-format" class="form-label">Time Format</label><select id="form-settings/time-format" class="form-select">
