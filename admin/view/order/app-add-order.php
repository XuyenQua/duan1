...
<form action="index.php?act=app-add-order" method="post" enctype="multipart/form-data">
                ...
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        <div class="col">
                            ...
                            <h1 class="h3 m-0">Thêm hóa đơn</h1>
                        </div>
                        <div class="col-auto d-flex"><a href="index.php?act=app-order-list" class="btn btn-secondary me-3">Danh sách hóa đơn</a><input type="submit" class="btn btn-primary" name="them" value="Lưu"></div>
                    </div>
                </div>
