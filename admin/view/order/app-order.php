            ...
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex">
                        <!-- <a href="index.php?act=app-delete-order&iddel=<?=$id?>" onclick="return confirm('bạn có muốn xóa hay không')"  class="btn btn-secondary me-3">Xóa</a> -->
                        <a href="index.php?act=app-edit-order&id=<?=$id?>" class="btn btn-primary">Sửa</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="sa-table">
                                    ...
                                    <tbody class="sa-table__group">
                                        ...
                                        <?php if($ma_giam_gia!=''){?>
                                        <tr>
                                            <td colSpan="3">Mã giảm giá : <?=$ma_giam_gia?><div class="text-muted fs-exact-13"></div>
                                            </td>
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">-<?= $giam_gia ?></span><span class="sa-price__integer"> VNĐ</span></div>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
