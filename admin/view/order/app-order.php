                    ...
                    <div class="col">
                        <nav class="mb-2" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-sa-simple">
                                ...
                                <li class="breadcrumb-item"><a href="app-orders-list.php">Orders</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Order #80294</li>
                            </ol>
                        </nav>
                        <h1 class="h3 m-0">Order #80294</h1>
                    </div>
                    <div class="col-auto d-flex"><a href="index.php?act=app-delete-bill" class="btn btn-secondary me-3">Delete</a>
                    <a href="index.php?act=app-edit-order" class="btn btn-primary">Edit</a></div>
                </div>
            </div>
            <div class="sa-page-meta mb-5">
                <div class="sa-page-meta__body">
                    <div class="sa-page-meta__list">
                        ...
                        <div class="sa-page-meta__item d-flex align-items-center fs-6"><span class="badge badge-sa-success me-2">Paid</span><span class="badge badge-sa-warning me-2">Partially Fulfilled</span></div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="sa-table">
                                    <tbody>
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center"><img src="view/images/products/product-2-40x40.jpg" class="me-4" width="40" height="40" alt="" /><a href="app-product.html" class="text-reset">Brandix Brake Kit BDX-750Z370-S</a></div>
                                            </td>
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span class="sa-price__integer"></span><span class="sa-price__decimal">.00</span></div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center"><img src="view/images/products/product-7-40x40.jpg" class="me-4" width="40" height="40" alt="" /><a href="app-product.html" class="text-reset">Glossy Gray 19&quot; Aluminium Wheel AR-19</a></div>
                                            </td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span class="sa-price__integer">1,398</span><span class="sa-price__decimal">.00</span></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center"><img src="view/images/products/product-16-40x40.jpg" class="me-4" width="40" height="40" alt="" /><a href="app-product.html" class="text-reset">Twin Exhaust Pipe From Brandix Z54</a></div>
                                            </td>
                                            <td class="text-end">
                                            ...
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span class="sa-price__integer">3,630</span><span class="sa-price__decimal">.00</span></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tbody class="sa-table__group">
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span class="sa-price__integer">5,877</span><span class="sa-price__decimal">.00</span></div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colSpan="3">Shipping<div class="text-muted fs-exact-13">via FedEx International</div>
                                            </td>
                                            <td class="text-end">
                                                <div class="sa-price"><span class="sa-price__symbol">$</span><span class="sa-price__integer">25</span><span class="sa-price__decimal">.00</span></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tbody>
                    ...
                    <div class="sa-entity-layout__sidebar">
                        <div class="card">
                            ...
                            <div class="card-body d-flex align-items-center pt-4">
                                <div class="sa-symbol sa-symbol--shape--circle sa-symbol--size--lg"><img src="view/images/customers/customer-1-40x40.jpg" width="40" height="40" alt="" /></div>
                                <div class="ms-3 ps-2">
                        ...
                        <div class="card mt-5">
                            <div class="card-body d-flex align-items-center justify-content-between pb-0 pt-4">
                                <h2 class="fs-exact-16 mb-0">Shipping Address</h2><a href="#" class="fs-exact-14">Edit</a>
                            </div>
                            <div class="card-body pt-4 fs-exact-14">Jessica Moore<br />Random Federation<br />115302, Moscow<br />ul. Varshavskaya, 15-2-178</div>
                        </div>
                        <div class="card mt-5">
                            <div class="card-body d-flex align-items-center justify-content-between pb-0 pt-4">
                                <h2 class="fs-exact-16 mb-0">Billing Address</h2><a href="#" class="fs-exact-14">Edit</a>
                            </div>
                            <div class="card-body pt-4 fs-exact-14">Jessica Moore<br />Random Federation<br />115302, Moscow<br />ul. Varshavskaya, 15-2-178</div>
                        </div>
                    </div>
