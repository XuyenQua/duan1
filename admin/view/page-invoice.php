        ...
        <div class="sa-invoice__card">
            <div class="sa-invoice__header">
                <div class="sa-invoice__meta">
                    ...
                    <div class="sa-invoice__meta-items"><span>Issue date:</span> Oct 19, 2020<br /><span>Due date:</span> Nov 19, 2020<br /></div>
                </div>
                <div class="sa-invoice__logo"><!-- invoice-logo -->
                    <div class="sa-invoice-logo">
                        <div class="sa-invoice-logo__body">
                            <div class="sa-invoice-logo__letters"><svg xmlns="http://www.w3.org/2000/svg" width="158" height="26" viewBox="0 0 158 26">
                            ...
                            c1.2,1.4,2,3.1,2,5c0,4.4-4,8-9,8c-4.3,0-8-2.6-8.9-6.2C-0.2,18.9,0.6,18,1.5,18z"></path>
                                </svg></div>
                            <div class="sa-invoice-logo__ribbon">
                                <div class="sa-invoice-logo__ribbon-start"><svg xmlns="http://www.w3.org/2000/svg" width="4" height="20" viewBox="0 0 4 20">
                                        <path d="M4,0v20H1.5C0.7,20,0,19.1,0,18s0.7-2,1.5-2S3,15.1,3,14s-0.7-2-1.5-2S0,11.1,0,10s0.7-2,1.5-2S3,7.1,3,6S2.3,4,1.5,4S0,3.1,0,2s0.7-2,1.5-2H4z"></path>
                                    </svg></div>
                                <div class="sa-invoice-logo__ribbon-middle">eCommerce  Admin  Template</div>
                                <div class="sa-invoice-logo__ribbon-end"><svg xmlns="http://www.w3.org/2000/svg" width="4" height="20" viewBox="0 0 4 20">
                                        <path d="M4,0v20H1.5C0.7,20,0,19.1,0,18s0.7-2,1.5-2S3,15.1,3,14s-0.7-2-1.5-2S0,11.1,0,10s0.7-2,1.5-2S3,7.1,3,6S2.3,4,1.5,4S0,3.1,0,2s0.7-2,1.5-2H4z"></path>
                                    </svg></div>
                                <div class="sa-invoice-logo__ribbon-drawer"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" viewBox="0 0 32 24">
                                        <path class="sa-roller-sponge" d="M4.5,24h-3C0.7,24,0,23.3,0,22.5v-17C0,4.7,0.7,4,1.5,4h3C5.3,4,6,4.7,6,5.5v17C6,23.3,5.3,24,4.5,24z"></path>
                                        <path class="sa-roller-stripes" d="M0,20l6-2v2l-6,2V20z M0,14l6-2v2l-6,2V14z M0,8l6-2v2l-6,2V8z"></path>
                                        <path class="sa-roller-handle" d="M30.8,18H20c0,0.6-0.4,1-1,1h-1c-0.6,0-1-0.4-1-1v-2h-2.6c-0.7,0-1.3-0.4-1.4-1.1L9.2,2H4v2H2V1.5
                                ...
                                C32,17.5,31.5,18,30.8,18z"></path>
                                    </svg></div>
                            </div>
                        </div>
                    </div><!-- invoice-logo / end -->
                </div>
            </div>
            <div class="sa-invoice__sides">
                <div class="sa-invoice__side">
                    ...
                    <div class="sa-invoice__side-meta">Land 4b4f53, MarsGrad, Sun Orbit, 43.3241-85.239<br />+0 800 306-8265, ryan@example.com</div>
                </div>
                <div class="sa-invoice__side">
                    <div class="sa-invoice__side-title">Invoice From</div>
                    <div class="sa-invoice__side-name">Stroyka Ltd.</div>
                    <div class="sa-invoice__side-meta">715 Fake Street, New York 10021 USA<br />+0 800 306-8265, stroyka@example.com</div>
                </div>
            </div>
