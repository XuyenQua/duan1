        ...
        <div class="container">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><a href="index.php?act=app-add-category" class="btn btn-primary">Thêm mới</a></div>
                </div>
            </div>
            <div class="card">
                ...
                <table class="sa-datatables-init" data-order="[[ 1, &quot;asc&quot; ]]" data-sa-search-input="#table-search">
                    ...
                    <tbody>
                        ...
                        foreach ($ds_dm as $dm) :
                            extract($dm);
                            $hinh = $img_path_admin.$anh_dm; ?>
                            <tr>
                                <td><input type="checkbox" class="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                <td><a href="index.php?act=app-category&iddm=<?=$id?>" class="text-reset"><?=$ten_dm?></a></td>
                                <td><img src="<?=$hinh?>" alt="" width="50"></td>
                                <td><?=$mo_ta_dm?></td>
                                <td>
                                    <div class="dropdown"><button class="btn btn-sa-muted btn-sm" type="button" id="category-context-menu-0" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg xmlns="http://www.w3.org/2000/svg" width="3" height="13" fill="currentColor">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0">
                                            <li><a class="dropdown-item" href="index.php?act=app-edit-category&id=<?=$id?>">Edit</a></li>
                                            ...
                                            <li><a class="dropdown-item text-danger" onclick="return confirm('bạn có muốn xóa hay không')"  href="index.php?act=app-delete-category&id=<?=$id?>">Xóa</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
