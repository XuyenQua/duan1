                            ...
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4"><label for="form-category/name"  class="form-label">Tên</label>
                                        <input type="text" class="form-control" name="ten_dm" id="form-category/name" value="<?=$ten_dm?>" required />
                                    </div>
                                    <div class="mb-4"><label for="form-category/mota" class="form-label">Mô tả</label>
                                        <input type="text" class="form-control" name="mo_ta_dm" id="form-category/mota" value="<?=$mo_ta_dm?>" required />
                                    </div>
                                    <div class="mb-4">
                                    <label class="form-label">Ảnh</label>
                                      <img src="<?=$img_path_admin.$anh_dm?>" width="100px" alt="">  
                                    </div>

                                    <div class="mb-4">
                                        <label for="form-category/image" class="form-label">Tải ảnh lên</label>
                                        <div class="file-upload-wrapper">
                                            <input type="file" id="form-category/image" name="image" class="file-upload"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
